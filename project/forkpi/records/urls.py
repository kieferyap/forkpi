...
urlpatterns = patterns('',
    ...
    url(r'^keypairs/add$', addpair, name='add keypair'),
    ...
    url(r'^keypairs/delete$', deletekeypair, name='delete keypair'),
    url(r'^keypairs/toggleactive$', toggleactivekeypair, name='keypair toggle active'),
    url(r'^keypairs/scanrfid$', addrfid, name='scan rfid'),
    url(r'^keypairs/printpdf$', printpdf, name='print pdf'),
